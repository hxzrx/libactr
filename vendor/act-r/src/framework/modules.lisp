...
;;; 2026.05.01 Dan
;;;             : * Fixed a typo in the warning for an invalid reset function,
;;;             :   and also have it note the module is not defined.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;
;;; General Docs:
;;; 
...
(defun define-module-fct (module-name buffer-list params-list
  ...
  (cond ((mp-models)
        ...
        ((not (or (and (not (listp reset)) (local-or-remote-function-or-nil reset))
         ...
         (print-warning
          "Reset parameter is not a function, function name, nil, or a list of one, two, or three such items.~%Module ~s not defined." module-name))
