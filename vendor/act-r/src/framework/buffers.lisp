...
;;;             :   are specified.
;;; 2025.05.27 Dan [7.3]
;;;             : * Schedule-set/overwrite-buffer-chunk now show the details
;;;             :   in the trace when it's not a chunk name instead of nothing.
;;; 2025.12.17 Dan [7.4]
;;;             : * The details with the previous change were fixed to show
;;;             :   strings as strings.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;
;;; General Docs:
            ...
            (t
             (schedule-event-relative time-delta 'set-buffer-chunk 
                                      ...
                                      :details (concatenate 'string 
                                                 (string 'set-buffer-chunk) " "
                                                 (string buffer-name) " "
                                                 (cond ((symbolp chunk-name-or-spec) ;; chunk name
                                                        (string chunk-name-or-spec))
                                                       ((listp chunk-name-or-spec) ;; description list
                                                        (prin1-to-string chunk-name-or-spec))
                                                       (t ;; chunk-spec or chunk-spec-id
                                                        (prin1-to-string (chunk-spec-to-chunk-def chunk-name-or-spec))))
                                                 (if requested
                                                     ""
                                                   " NIL"))
