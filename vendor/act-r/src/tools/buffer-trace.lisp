...
;;; 2025.05.22 Dan 
;;;             : * Fixed the set-buffer-chunk case of buffer-trace-event-
;;;             :   recorder so that it handles the situation where a list of
;;;             :   a chunk definition is provided.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;
;;; General Docs:
;;; 
                 ...
                 (awhen (find bn (buffer-record-buffers (btm-current-summary btm)) :key 'buffer-summary-name)
                        (setf (buffer-summary-chunk-name it) 
                          (if (symbolp (second (act-r-event-params evt)))
                            ...
                            (format nil "~S" (if (act-r-chunk-spec-p (second (act-r-event-params evt)))
                                                 (chunk-spec-to-chunk-def (second (act-r-event-params evt)))
