...
(defun present-one-attribute-fct (name value)
  (goal-focus-fct (list 'state 'add-attribute 'name name 'value (+ *attribute-offset* value)))
  (run 20))
...
(load (resolve-path "act-r" "tutorial/unit8/categorize-model.lisp"))
