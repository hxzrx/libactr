...
(load (resolve-path "act-r" "tutorial/unit5/fan-no-pm-model.lisp"))
...
(defun fan-sentence (person location target term)
  ...
  ; modify the chunk in the goal buffer to set the 
  ; arg1 and arg2 slots to the probe items 
  
  (mod-focus-fct (list 'arg1 person 'arg2 location))
...
; through the output-person-location function.
