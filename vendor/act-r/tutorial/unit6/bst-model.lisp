...
(define-chunks 
    start find-line looking attending encode-under
    encode-over choose-strategy calculate-difference 
    consider-next check-for-done read-done evaluate-c
    prepare-mouse evaluate-a over under move-mouse
    wait-for-click)
...
(goal-focus (isa try-strategy state start))
