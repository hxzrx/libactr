...
(define-model compilation-test
  ...
  (define-chunks win draw lose attend-num-1  
    encode-num-1 find-num-2 attend-num-2 encode-num-2  
    num2 retrieve-past-trial process-past-trial  
    respond guess-other detect-feedback encode-feedback)
