...
Never edit files here. Refresh by re-vendoring from the source repo — see
"Upgrading the vendored oracle" in the repository README for the full two-hop
procedure (actr7.x SVN → act-r port → this tree).

- Source repo:   https://gitee.com/hxz/act-r (git@gitee.com:hxz/act-r.git)
- Snapshot:      act-r @ da413e665c7657de1d88a868a92dfac9f60aaaef
- Upstream:      official ACT-R SVN r3493 (`svn://act-r.psy.cmu.edu/actr7.x`,
                 ACT-R 7.31.5); sync record in `act-r/docs/upstream-sync.md`
                 in the source repo
