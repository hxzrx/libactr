...
;;;; :libactr/fraction-tutor. Buggy rules are appended (libactr-only). KC attribution is
...
buggy library. Model symbols land in :libactr/fraction-tutor (*PACKAGE* binding)."
  (let ((*package* (find-package :libactr/fraction-tutor)))
